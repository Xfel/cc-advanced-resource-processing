...
public class RecipeType
{
  ...
  public static final RecipeType CRAFTING = getOrCreateRecipeType("crafting", 3, 3);

  public static final RecipeType FURNACE = getOrCreateRecipeType("furnace", 1, 1);
  private String id;
  ...
  public static RecipeType getOrCreateRecipeType(String id, int gridWidth, int gridHeight)
  {
    id = id.toLowerCase();
